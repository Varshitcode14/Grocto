...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'postgresql://grocto_for_cisco_user:vMImSC0WEJUJNDmALX3kB4ss7xLWQSno@dpg-d2mt0n8gjchc73d37lc0-a.oregon-postgres.render.com/grocto_for_cisco')
